...
public class ActiveConsumer {
	...
	static final String RESULT_FILE_NAME = "ActiveResult/ActiveConsumer-";
	...
	public static void main(String[] args) throws Exception {
		...
		pw.println("Consumer-" + args[0] + " Start Time : " + System.currentTimeMillis());
		try {
			while (true) {
			...
			pw.println("Consumer-" + args[0] + " End Time : " + System.currentTimeMillis());
